...
const FeatureCard2 = ({ ttl, desc }) => {
  return (
    <div className='relative rounded-lg w-[80vw] h-[80vw] md:w-[27vw] md:h-[27vw] bg-bc1 flex items-end justify-end text-white'>
      <div className='absolute top-0 left-0 max-w-full p-[2vw]'>
        <div className='flex flex-col items-start justify-around gap-[2vw] py-[2vw]'>
          <h4 className='text-[5vw] md:text-[1.7vw]'>{ttl}</h4>
      ...
      <div className='absolute -right-2 -bottom-2 rounded-lg w-[20vw] h-[20vw] md:w-[8vw] md:h-[8vw] border-[2vw] md:border-[1vw] border-white bg-white'>
        <div className='flex items-center justify-center w-full h-full bg-bcgr cursor-pointer rounded-lg'>
